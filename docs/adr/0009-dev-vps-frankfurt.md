...
- **Статус:** Superseded by [ADR-0010](./0010-dev-vps-fastvps.md) (2026-07-20)
- **Дата:** 2026-05-12
- **Авторы:** Максим Ерохин

> **Superseded 2026-07-20.** После ~2 мес простоя Frankfurt-бокс `95.81.94.83` стал недоступен по SSH (вероятно приостановлен/выключен). Dev VPS заменён на FastVPS `5.188.20.39` (Ubuntu 26.04) — см. [ADR-0010](./0010-dev-vps-fastvps.md). Основной вывод 0009 (dev-бокс вне РФ, прямой доступ к Telegram без WG) сохранён — новый бокс тоже ходит к Telegram напрямую (bootstrap + listener подключились успешно).
